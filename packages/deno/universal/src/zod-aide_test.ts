...
Deno.test("Zod Aide unwrapped clone", () => {
  ...
  const textDefaultable = z
    .string()
    .optional()
    .default("textDefaultable defaultValue");
  ...
  const textDefaultableUCO = za
    .coreZTA(za.clonedZodType(textDefaultable))
    .optional()
    .default("textDefaultableUCO default value");
