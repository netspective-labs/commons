// TODO: Need the ts-ignore because nlc-deno-sqla does not have typescript declarations due to dnt configuration issue
// @ts-ignore
import * as SQLa from "@netspective-labs/nlc-deno-sqla";

const ctx = SQLa.typicalSqlEmitContext();
type EmitContext = typeof ctx;

const stso = SQLa.typicalSqlTextSupplierOptions<EmitContext>();
const dvg = SQLa.dataVaultGovn<EmitContext>(stso);
